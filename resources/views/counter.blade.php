...
<body>
  <div class="container">
    <div class="title">
      ...
      <div style="display: inline; margin-bottom: 48px" class="title-text">欢迎使用长江云小程序</div>
    </div>
    <div style="text-align: center; display: flex; flex-direction: column; align-items: center; margin: 0">
      ...
      <div class="card" style="width: 320px; margin-bottom: 48px;">
        <div class="card-body">
          ...
          <small class="card-text" style="display: flex; justify-content: center; margin-top: 8px">扫码加入长江云托管用户群</small>
        </div>
      </div>
      <div>
        <div class="hr">
